export default function Section1() {
  return (
    <div className="flex p-28 border-2">
      <div className="w-3/5  p-10 border-2 mr-10 shadow-lg shadow-gray-500">
        <label htmlFor="" className="py-2 mr-32">
          Name
        </label>
        <label htmlFor="" className="py-2 ml-36">
          Phone
        </label>
        ...
        <div className="flex flex-col py-2">
          ...
          <input type="text" className="border-2 mr-10 p-3" />
        </div>
        <div className="flex flex-col py-2">
          <label htmlFor="" className="py-2">
            Write Message
          </label>
          <textarea type="textarea" className="border-2 mr-10 h-40" />
        </div>
        <button
